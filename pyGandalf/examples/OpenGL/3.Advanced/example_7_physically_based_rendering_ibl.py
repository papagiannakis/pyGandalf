...
def main():
    ...
    Application().create(OpenGLWindow('Physically Based Rendering(PBR) with Image Based Light(IBL)', 1280, 720, True), OpenGLRenderer)

    # Create a new scene
    scene = Scene('Physically Based Rendering(PBR) with Image Based Light(IBL)')
