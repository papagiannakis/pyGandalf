...
def main():
    ...
    scene.add_component(cube_face_right, MaterialComponent('M_Unlit')).color = glm.vec3(0.0, 0.0, 1.0)
    ...
    scene.add_component(cube_face_left, MaterialComponent('M_Unlit')).color = glm.vec3(0.0, 0.0, 1.0)
    ...
    scene.add_component(cube_face_top, MaterialComponent('M_Unlit')).color = glm.vec3(1.0, 1.0, 0.0)
    ...
    scene.add_component(cube_face_bottom, MaterialComponent('M_Unlit')).color = glm.vec3(1.0, 1.0, 0.0)
