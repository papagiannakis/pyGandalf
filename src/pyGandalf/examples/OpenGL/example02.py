...
from pyGandalf.scene.components import InfoComponent, TransformComponent, LinkComponent, OpenGLRenderComponent, MaterialComponent, CameraComponent
...
def main():
    ...
    scene.add_component(camera, CameraComponent(30, 1.778, 0.1, 1000, 1.2, CameraComponent.Type.PERSPECTIVE))
    ...
    scene.add_component(camera_alt, TransformComponent(glm.vec3(1, 0, 5), glm.vec3(0, 0, 0), glm.vec3(1, 1, 1)))
    scene.add_component(camera_alt, LinkComponent(None))
    scene.add_component(camera_alt, CameraComponent(30, 1.778, 0.1, 1000, 1.2, CameraComponent.Type.ORTHOGRAPHIC, False))
